...
export const metadata: Metadata = createMetadata(
  "БЕРТА AS63 — алюминиевая оконно-дверная система",
  "Тёплая алюминиевая система БЕРТА AS63 для окон, дверей, витражей и входных групп.",
  "/products/as63",
  "/images/as63-detail/don63-08-20260908.png",
);
...
const specifications = [
  { value: "R₀ = 0,67 м²·°C/Вт", label: "Теплоизоляция" },
  { value: "63 мм", label: "Видимая ширина" },
  { value: "42 мм", label: "Толщина заполнения" },
  { value: "более 50 лет", label: "Долговечность" },
];

const advantages = [
  {
    image: "/images/as63-detail/don63-07-20260908.png",
    title: "Терморазрыв с полиамидными вставками",
    description: "Обеспечивает высокую энергоэффективность и комфорт в помещении.",
  },
  {
    image: "/images/as63-detail/don63-08-20260908.png",
    title: "Современный дизайн",
    description: "Прямые линии, минимализм и эстетика алюминия для любых архитектурных решений.",
  },
  {
    image: "/images/as63-detail/large-openings.jpg",
    title: "Большие световые проёмы",
    description: "Возможность реализации крупногабаритных конструкций без потери прочности.",
  },
  {
    image: "/images/as63-detail/don63-07-20260908.png",
    title: "Надёжность в любых условиях",
    description: "Устойчивость к нагрузкам, перепадам температур и агрессивной среде.",
  },
  {
    image: "/images/as63-detail/hardware.jpg",
    title: "Совместимость с фурнитурой",
    description: "Поддержка широкой линейки европейской фурнитуры и аксессуаров.",
  },
];

const applications = [
  { image: "/images/as63-detail/residential.jpg", title: "Жилые комплексы и частные дома" },
  { image: "/images/as63-detail/offices.jpg", title: "Офисные и бизнес-центры" },
  { image: "/images/as63-detail/public-buildings.jpg", title: "Общественные здания" },
  { image: "/images/as63-detail/renovation.jpg", title: "Реконструкция и реновация" },
];

const documents = [{ title: "Доступные сертификаты и материалы", meta: "Раздел документации" }];

export default function AS63Page() {
  return (
    <>
      <section className="relative overflow-hidden bg-[#07111a] pt-[72px] text-white">
        <Image
          src="/images/as63-detail/hero-wide-20260908.png"
          alt="Профиль алюминиевой системы БЕРТА AS63"
          fill
          priority
          sizes="100vw"
        ...
        <Container className="relative z-10 flex min-h-[610px] flex-col py-7 sm:min-h-[650px] sm:py-9 lg:min-h-[690px]">
          ...
          <div className="my-auto max-w-[600px] py-8 sm:py-10">
            <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-accent sm:text-xs">
              Алюминиевая оконно-дверная система
            </p>
            ...
            <p className="mt-6 max-w-[490px] text-base leading-7 text-white/78 sm:text-lg">
              Система рамного остекления с терморазрывом для окон, дверей и витражных конструкций.
            </p>
            ...
            {advantages.map((advantage) => (
              <article key={advantage.title} className="overflow-hidden rounded-xl border border-ink/8 bg-white">
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image src={advantage.image} alt={advantage.title} fill sizes="(max-width: 640px) 100vw, (max-width: 1280px) 33vw, 20vw" className={advantage.image.endsWith(".png") ? "bg-[#e9edef] object-contain p-3 transition duration-700 hover:scale-[1.03]" : "object-cover transition duration-700 hover:scale-[1.03]"} />
                </div>
                <div className="p-5">
        ...
        <Container>
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {applications.map((application) => (
              <Link key={application.title} href="/projects" className="group relative min-h-[270px] overflow-hidden rounded-xl bg-[#07111a] text-white">
                <Image src={application.image} alt={application.title} fill sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 25vw" className="object-cover transition duration-700 group-hover:scale-[1.035]" />
      ...
      <section className="bg-[#f4f5f6] py-12 sm:py-14 lg:py-16">
        <Container className="grid gap-4 lg:grid-cols-[0.78fr_1.72fr]">
          ...
          <div className="relative min-h-[360px] overflow-hidden rounded-xl bg-[#07111a] text-white sm:min-h-[340px]">
            <Image src="/images/as63-detail/hero-wide-20260908.png" alt="Профиль системы БЕРТА AS63" fill sizes="(max-width: 1024px) 100vw, 70vw" className="object-contain object-right p-4 opacity-90" />
            ...
            <div className="relative flex min-h-[360px] max-w-[600px] flex-col justify-center p-6 sm:min-h-[340px] sm:p-9 lg:p-11">
              <h2 className="text-balance text-3xl font-semibold leading-[1.02] tracking-[-0.045em] sm:text-4xl">
                Нужна консультация по системе БЕРТА AS63?
              </h2>
